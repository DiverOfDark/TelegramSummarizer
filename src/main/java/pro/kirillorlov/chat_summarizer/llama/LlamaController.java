...
public class LlamaController {
    ...
    public String SUMMARIZE_N2_PROMPT = "\n\nЭто несколько списков тезисов что обсуждали сегодня в чате. Исправь нумерация, чтобы она была консистента. Если подряд идут два пункта об одном и том же - объедени их в один.";
